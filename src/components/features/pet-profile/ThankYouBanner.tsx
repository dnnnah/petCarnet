...
export function ThankYouBanner({ petName, species }: ThankYouBannerProps) {
  const PetIcon = species.toLowerCase().includes("gato") ? Cat : Dog;

  return (
    <footer className="relative overflow-hidden rounded-[2.25rem] bg-gradient-to-r from-emerald-50 via-emerald-100/55 to-blue-50 p-6 shadow-[0_16px_38px_rgba(16,185,129,0.09)] sm:p-8">

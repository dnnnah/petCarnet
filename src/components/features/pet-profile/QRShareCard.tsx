    ...
    <GlassCard className="h-full overflow-hidden bg-emerald-50/80 p-5 lg:p-6">
      <div className="grid h-full grid-cols-[1fr_auto] items-center gap-4 lg:grid-cols-1">
        ...
        <div className="flex flex-col items-center gap-3">
          <div
            ref={qrRef}
            className="grid aspect-square w-32 shrink-0 place-items-center rounded-3xl bg-white p-3 shadow-[0_18px_32px_rgba(17,24,39,0.12)] sm:w-40 lg:mx-auto lg:w-44"
          >
            <QRCodeSVG
              value={fullUrl}
              size={160}

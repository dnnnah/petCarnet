          ...
          <>
            {expanded ? (
              <div className="space-y-5">
                {hasMedications ? (
                  <div>
                    <span className="inline-flex items-center gap-2 rounded-full bg-violet-100/72 px-5 py-1.5 text-sm font-extrabold text-gray-800 ring-1 ring-violet-200/70">
                      <Pill size={14} />
                      Medicamentos
                    </span>
                    <ul className="mt-3 list-disc space-y-1 pl-6 font-semibold text-gray-800">
                ...
                {hasDiet ? (
                  <div>
                    <span className="inline-flex rounded-full bg-orange-100/72 px-5 py-1.5 text-sm font-extrabold text-gray-800 ring-1 ring-orange-200/70">
                      Dieta especial
                    </span>
                    <p className="mt-3 font-semibold leading-7 text-gray-800">{health.diet}</p>
                  </div>
                ) : null}
              </div>
            ) : null}
            ...
            <button
              ...
              className="mx-auto flex items-center gap-2 text-sm font-extrabold text-emerald-600 transition hover:text-emerald-700"
            >
